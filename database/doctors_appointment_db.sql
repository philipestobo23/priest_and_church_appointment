...
--
-- Database: `priest_appointment_db`
--
...
INSERT INTO `appointment_list` (`id`, `priest_id`, `client_id`, `schedule`, `status`, `date_created`) VALUES
...
--
-- Table structure for table `priest_list`
--

CREATE TABLE `priest_list` (
  `id` int(30) NOT NULL,
  `name` text NOT NULL,
...
--
-- Dumping data for table `priest_list`
--

INSERT INTO `priest_list` (`id`, `name`, `name_pref`, `church_address`, `contact`, `email`, `specialty_ids`, `img_path`, `date_created`) VALUES
...
INSERT INTO `priest_schedule` (`id`, `priest_id`, `day`, `time_from`, `time_to`) VALUES
...
--
-- Table structure for table `church_specialty`
--

CREATE TABLE `church_specialty` (
  `id` int(30) NOT NULL,
  `name` text NOT NULL,
  `img_path` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `church_specialty`
--

INSERT INTO `church_specialty` (`id`, `name`, `img_path`) VALUES
...
CREATE TABLE `users` (
  ...
  `type` tinyint(1) NOT NULL DEFAULT 2 COMMENT '1=admin , 2 = doctor,3=client'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `users` (`id`, `priest_id`, `name`, `address`, `contact`, `username`, `password`, `type`) VALUES
...
--
-- Indexes for table `priest_list`
--
ALTER TABLE `priest_list`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `church_specialty`
--
ALTER TABLE `church_specialty`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `priest_list`
--
ALTER TABLE `priest_list`
...
--
-- AUTO_INCREMENT for table `church_specialty`
--
ALTER TABLE `church_specialty`
