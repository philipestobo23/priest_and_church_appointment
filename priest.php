<?php include 'admin/db_connect.php'; 
	...
	$special = $conn->query("SELECT * FROM church_specialty");
	$ms_arr = array();
...
?>
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4 page-title">
                    	<h3 class="text-white">Priest's</h3>
	...
	<section class="page-section" id="priest" >
        <div class="container">
        	<div class="card">
        		<div class="card-body">
        			<div class="col-lg-12">
						...
						<div class="row">
							<div class="col-md-12 text-center">
								<?php
								$s = $conn->query("SELECT * from church_specialty where id = ".$_GET['sid'])->fetch_array()['name'];
								?>
								<h2><b>Priest/'s who are in titled as <?php echo $s ?></b></h2>
							</div>
						</div>
						<hr class="divider">
						<?php endif; ?>
				...
				$cats = $conn->query("SELECT * FROM priest_list ".$where." order by id asc");
				...
				<div class="row align-items-center">
					...
					<div class="col-md-6">
						 ...
						 <p><small>Church Address: <b><?php echo $row['church_address'] ?></b></small></p>
						 ...
						 <div>
						 	...
						 	?>
						 	<span class="badge badge-light" style="padding: 2px"><small><b><?php echo $ms_arr[$val] ?></b></small></span>
						 	<?php endforeach; ?>
						 	<?php endif; ?>
						 </div>
					</div>
					<div class="col-md-3 text-center align-self-end-sm">
						<button class="btn-outline-primary  btn  mb-4 set_appointment" type="button" data-id="<?php echo $row['id'] ?>"  data-name="<?php echo "Fr. ".$row['name'].', '.$row['name_pref'] ?>">Set Appointment</button>
					</div>
				</div>
    ...
    <script>
       ...
       $('.view_schedule').click(function(){
			uni_modal($(this).attr('data-name')+" - Schedule","view_priest_schedule.php?id="+$(this).attr('data-id'))
		})
