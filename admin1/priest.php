				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="name_pref" placeholder="(Fr.)" required="">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<textarea name="church_address" id="" cols="30" rows="2" class="form-control" required=""></textarea>
							</div>
							<div class="form-group">
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$cats = $conn->query("SELECT * FROM priest_list order by id asc");
								...
								<tr>
									...
									<td class="">
										 <p>Name: <b><?php echo "Fr. ".$row['name'].', '.$row['name_pref'] ?></b></p>
...
<script>
	...
	$('.edit-doctor').click(function(){
		...
		cat.find("[name='church_address']").val($(this).attr('data-church_address'))
	...
	$('.delete_doctor').click(function(){
		_conf("Are you sure to delete this Priest?","delete_doctor",[$(this).attr('data-id')])
	})
