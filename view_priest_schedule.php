...
<?php 
	...
	$qry = $conn->query("SELECT * FROM priest_schedule where priest_id=".$_GET['id']);
?>
...
<script>
	$('#edit').click(function(){
		uni_modal("Edit "+$('#uni_modal .modal-title').html(),'manage_priest_schedule.php?did=<?php echo $_GET['id'] ?>','mid-large');
	})
</script>